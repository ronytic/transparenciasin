	...
	<tr class="contenido">
		...
		if($enlaces==1){
			...
			?>
				...
				<td><a href="<?php echo $v;?>?<?php if(!empty($adicional)){foreach($adicional as $ak=>$av){ echo $ak."=".$av."&";}}?>id=<?php echo $id;?>" class="botonmostazapequeno" target="<?php echo $target?>"><?php echo $k; ?></a></td>	
				<?php endforeach ?>
			<?php
			}
		}
